...
public sealed partial class CfgHighlightData :  Bright.Config.BeanBase 
{
    public CfgHighlightData(JSONNode _json) 
    {
    ...
    public CfgHighlightData(int id, string desc, string rootTargetName, string relativeTargetPath, bool isExecute ) 
    {
        this.Id = id;
        this.Desc = desc;
    ...
    public static CfgHighlightData DeserializeCfgHighlightData(JSONNode _json)
    {
        return new Cfg.CfgHighlightData(_json);
    }
    ...
    public const int __ID__ = 1756567812;
